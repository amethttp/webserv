...
#include "WebServer/Connection/Request/RequestTokenizer/RequestTokenizer.hpp"
#include "WebServer/Connection/Request/RequestTokenizer/RequestToken/RequestToken.hpp"
...
public:
    ...
    Result<RequestLine> parseRequestLine();
